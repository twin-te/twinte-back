...
// func (r *Impl) CreateUser(ctx context.Context, user *authentity.User) error {
// 	return r.innerTransaction(ctx, func(db boil.ContextTransactor) error {
// 		dbUser := &dbmodel.User{
// 			ID:        user.ID.String(),
// 			CreatedAt: time.Now(),
...
// 		if err := dbUser.Insert(ctx, db, boil.Infer()); err != nil {
// 			return err
// 		}

// 		dbAuthentications := make(dbmodel.UserAuthenticationSlice, 0, len(user.Authentications))
// 		for _, authentication := range user.Authentications {
// 			dbAuthentication, err := toDBUserAuthentication(user.ID, authentication)
// 			if err != nil {
// 				return err
// 			}
// 			dbAuthentications = append(dbAuthentications, dbAuthentication)
// 		}

// 		// TODO: use batch insert
// 		for _, dbAuthentication := range dbAuthentications {
// 			if err := dbAuthentication.Insert(ctx, db, boil.Infer()); err != nil {
// 				return err
// 			}
// 		}
...
// func (r *Impl) UpdateUser(ctx context.Context, user *authentity.User) error {
// 	return r.innerTransaction(ctx, func(db boil.ContextTransactor) error {
// 		dbUser := &dbmodel.User{
// 			ID: user.ID.String(),
// 		}

// 		ok, err := dbUser.Exists(ctx, db)
// 		if err != nil {
// 			return err
// 		}
// 		if !ok {
